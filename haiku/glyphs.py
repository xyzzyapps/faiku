...
HAND: dict[str, np.ndarray] = {
    ...
    "a": np.array([[0.22, 0.78], [0.5, 0.18], [0.78, 0.78], [0.32, 0.52], [0.68, 0.52]], np.float32),
    "b": np.array([[0.28, 0.18], [0.28, 0.82], [0.62, 0.28], [0.28, 0.48], [0.68, 0.72], [0.28, 0.82]], np.float32),
    "c": _arc(0.52, 0.5, 0.28, 0.6, 5.6),
    "d": np.array([[0.72, 0.18], [0.72, 0.82], [0.38, 0.72], [0.32, 0.5], [0.38, 0.28], [0.72, 0.22]], np.float32),
    "e": np.array([[0.72, 0.22], [0.28, 0.22], [0.28, 0.5], [0.62, 0.5], [0.28, 0.5], [0.28, 0.8], [0.72, 0.8]], np.float32),
    "f": np.array([[0.72, 0.2], [0.32, 0.2], [0.32, 0.82], [0.32, 0.48], [0.62, 0.48]], np.float32),
    "g": np.concatenate([_arc(0.5, 0.42, 0.26, 0.4, 5.8), np.array([[0.72, 0.5], [0.72, 0.82], [0.4, 0.82]], np.float32)]),
    "h": np.array([[0.28, 0.18], [0.28, 0.82], [0.28, 0.48], [0.72, 0.48], [0.72, 0.82]], np.float32),
    "i": np.array([[0.5, 0.2], [0.5, 0.78], [0.38, 0.78], [0.62, 0.78], [0.5, 0.2], [0.5, 0.12]], np.float32),
    "j": np.array([[0.62, 0.18], [0.62, 0.72], [0.42, 0.86], [0.3, 0.72]], np.float32),
    "k": np.array([[0.28, 0.18], [0.28, 0.82], [0.28, 0.5], [0.72, 0.2], [0.28, 0.5], [0.72, 0.82]], np.float32),
    "l": np.array([[0.32, 0.18], [0.32, 0.8], [0.68, 0.8]], np.float32),
    "m": np.array([[0.18, 0.8], [0.18, 0.22], [0.5, 0.62], [0.82, 0.22], [0.82, 0.8]], np.float32),
    "n": np.array([[0.28, 0.8], [0.28, 0.22], [0.72, 0.78], [0.72, 0.2]], np.float32),
    "o": _arc(0.5, 0.5, 0.3, 0.0, 6.4),
    "p": np.array([[0.28, 0.82], [0.28, 0.18], [0.62, 0.22], [0.7, 0.4], [0.28, 0.5]], np.float32),
    "q": np.concatenate([_arc(0.48, 0.48, 0.28, 0.0, 6.3), np.array([[0.62, 0.62], [0.78, 0.84]], np.float32)]),
    "r": np.array([[0.28, 0.82], [0.28, 0.18], [0.62, 0.22], [0.68, 0.4], [0.28, 0.48], [0.7, 0.82]], np.float32),
    "s": np.array([[0.7, 0.28], [0.4, 0.18], [0.28, 0.38], [0.7, 0.58], [0.5, 0.82], [0.28, 0.72]], np.float32),
    "t": np.array([[0.22, 0.22], [0.78, 0.22], [0.5, 0.22], [0.5, 0.82]], np.float32),
    "u": np.array([[0.28, 0.2], [0.28, 0.7], [0.5, 0.82], [0.72, 0.7], [0.72, 0.2]], np.float32),
    "v": np.array([[0.22, 0.2], [0.5, 0.82], [0.78, 0.2]], np.float32),
    "w": np.array([[0.15, 0.2], [0.32, 0.82], [0.5, 0.42], [0.68, 0.82], [0.85, 0.2]], np.float32),
    "x": np.array([[0.22, 0.2], [0.78, 0.82], [0.5, 0.5], [0.22, 0.82], [0.78, 0.2]], np.float32),
    "y": np.array([[0.22, 0.18], [0.5, 0.52], [0.78, 0.18], [0.5, 0.52], [0.5, 0.84]], np.float32),
    "z": np.array([[0.22, 0.22], [0.78, 0.22], [0.22, 0.8], [0.78, 0.8]], np.float32),
}
